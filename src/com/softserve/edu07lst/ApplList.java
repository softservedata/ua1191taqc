package com.softserve.edu07lst;
...
public class ApplList {
    ...
    public static void main(String[] args) {
		...
		*/
		...
		//list.set(0, "One more first element"); // keep at position 0
        list.add(0, "One more first element"); // insert at position 0
		System.out.println("Updated: list = " + list);
        //
        //list.remove("First element");
        //list.remove(1);
        //System.out.println("Updated2: list = " + list);
        //
        //List<String> removeElements = List.of("First element", "Fourth element");
        //list.removeAll(removeElements);
        //System.out.println("Updated3: list = " + list)
        //
        List<String> retainElements = List.of("First element", "Fourth element");
        list.retainAll(retainElements);
        System.out.println("Updated4: list = " + list);
        // */
		/*-
